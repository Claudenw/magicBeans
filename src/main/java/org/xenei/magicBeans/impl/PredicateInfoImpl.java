...
public class PredicateInfoImpl implements PredicateInfo {
	 ...
	 */
	public static ObjectHandler getHandler(final Factory factory, final Class<?> returnType,
	 ...
	 * 
	 * @param factory
	 *            The Factory that this predicate is associated with.
	 * @param predicate
	 ...
	 */
	public PredicateInfoImpl(final Factory factory, final EffectivePredicate predicate,
	 ...
	 * 
	 * @param factory
	 *            the Factory to use for the object handler.
	 * @return the ObjectHandler instance for this predicate info
	 */
	public ObjectHandler getObjectHandler(Factory factory) {
	 ...
	 */
	public Object exec(final Factory factory, final Method method, final Resource resource,
			final Object[] args) {
	...
	private Object execSet(final Factory factory, final ObjectHandler objectHandler,
			final Resource resource, final Property p, final Object[] args) {
